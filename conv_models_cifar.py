...
def conv_model():
    ...
    ae_input = Input(shape=(32,32,3), name="AE_input")
...
def DQN_model():
    ...
    x = Conv2D(4, (8, 8), activation='relu', padding='same')(input_img)
    x = MaxPooling2D((2, 2), padding='same')(x)
    ...
    x = Dense(16384, activation='relu')(decoder_input)
    ...
    # Convolutional autoencoder
    ae_input = Input(shape=(128,128,3), name="AE_input")
    ae_encoder_output = encoder(ae_input)
    ae_decoder_output = decoder(ae_encoder_output)
